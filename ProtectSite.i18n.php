 ...
 */
$messages['ast'] = array(
	'protectsite' => 'Protexer el sitiu',
	'protectsite-desc' => 'Permite a un alministrador del sitiu bloquiar temporalmente dellos cambios al mesmu',
	'protectsite-text-protect' => "<!-- Instrucciones/Comentarios/Política d'usu -->",
	'protectsite-text-unprotect' => '<!-- Instrucciones/Comentarios demientres la proteición -->',
	'protectsite-title' => 'Configuración de la protección del sitiu',
	'protectsite-allowall' => 'Tolos usuarios',
	'protectsite-allowusersysop' => 'Usuarios rexistraos y alministradores',
	'protectsite-allowsysop' => 'Solo alministradores',
	'protectsite-createaccount' => 'Permitir la creación de cuentes nueves por',
	'protectsite-createpage' => 'Permitir la creación de páxines por',
	'protectsite-edit' => 'Permitir la edición de páxines por',
	'protectsite-move' => 'Permitir el treslláu de páxines por',
	'protectsite-upload' => 'Permitir la carga de ficheros por',
	'protectsite-timeout' => 'Tiempu máximu:',
	'protectsite-timeout-error' => "'''Tiempu de caducidá inválidu.'''",
	'protectsite-maxtimeout' => 'Máximu: $1',
	'protectsite-comment' => 'Comentariu:',
	'protectsite-ucomment' => 'Comentariu de desprotección:',
	'protectsite-until' => 'Protexío fasta:',
	'protectsite-protect' => 'Protexer',
	'protectsite-unprotect' => 'Desprotexer',
	'protectsite-createaccount-0' => 'Tolos usuarios',
	'protectsite-createaccount-1' => 'Usuarios rexistraos y alministradores',
	'protectsite-createaccount-2' => 'Solo alministradores',
	'protectsite-createpage-0' => 'Tolos usuarios',
	'protectsite-createpage-1' => 'Usuarios rexistraos y alministradores',
	'protectsite-createpage-2' => 'Solo alministradores',
	'protectsite-edit-0' => 'Tolos usuarios',
	'protectsite-edit-1' => 'Usuarios rexistraos y alministradores',
	'protectsite-edit-2' => 'Solo alministradores',
	'protectsite-move-0' => 'Usuarios rexistraos y alministradores',
	'protectsite-move-1' => 'Solo alministradores',
	'protectsite-upload-0' => 'Usuarios rexistraos y alministradores',
	'protectsite-upload-1' => 'Solo alministradores',
	'right-protectsite' => "Torgar les aiciones que puen facer dellos grupos d'usuarios por un tiempu determináu",
);
 ...
 */
$messages['azb'] = array(
	'protectsite' => 'سایتی قورو',
	'protectsite-desc' => 'بیر ایداره‌چی‌یه ایجازه وئرر فرقلی سایت‌دا دَییشیکلیک ایمکانلارینی، گئچیجی اولاراق باغلاسین',
	'protectsite-text-protect' => '<!-- ایستیفاده اوچون تعلیمات/شرح/سیاست -->',
	'protectsite-text-unprotect' => '<!-- قورولان حال‌دا تعلیمات/شرح -->',
	'protectsite-title' => 'سایت قوروما تنظیملری',
	'protectsite-allowall' => 'بوتون ایستیفاده‌چیلر',
	'protectsite-allowusersysop' => 'آد یازدیرمیش ایستیفاده‌چیلر و ایداره‌چیلر',
	'protectsite-allowsysop' => 'یالنیز ایداره‌چیلر',
	'protectsite-createaccount' => 'بونلارلا یئنی حساب یارادیلماسینا ایجازه وئر',
	'protectsite-createpage' => 'بونلارلا صحیفه یارادیلماسینا ایجازه وئر',
	'protectsite-edit' => 'بونلارلا صحیفه دَییشدیرمه‌سینه ایجازه وئر',
	'protectsite-move' => 'بونلارلا صحیفه داشیماسینا ایجازه وئر',
	'protectsite-upload' => 'بونلارلا فایل یوکله‌مه‌سینه ایجازه وئر',
	'protectsite-timeout' => 'زامان-آشیمی:',
	'protectsite-timeout-error' => "'''گئچرسیز زامان-آشیمی.'''",
	'protectsite-maxtimeout' => 'ان چوخ: $1',
	'protectsite-comment' => 'شرح:',
	'protectsite-ucomment' => 'قورونمامیش شرح:',
	'protectsite-until' => 'بونا کیمی قورونموش:',
	'protectsite-protect' => 'قورو',
	'protectsite-unprotect' => 'قوروماق‌دان چیخارت',
	'protectsite-createaccount-0' => 'بوتون ایستیفاده‌چیلر',
	'protectsite-createaccount-1' => 'آد یازدیرمیش ایستیفاده‌چیلر و ایداره‌چیلر',
	'protectsite-createaccount-2' => 'یالنیز ایداره‌چیلر',
	'protectsite-createpage-0' => 'بوتون ایستیفاده‌چیلر',
	'protectsite-createpage-1' => 'آد یازدیرمیش ایستیفاده‌چیلر و ایداره‌چیلر',
	'protectsite-createpage-2' => 'یالنیز ایداره‌چیلر',
	'protectsite-edit-0' => 'بوتون ایستیفاده‌چیلر',
	'protectsite-edit-1' => 'آد یازدیرمیش ایستیفاده‌چیلر و ایداره‌چیلر',
	'protectsite-edit-2' => 'یالنیز ایداره‌چیلر',
	'protectsite-move-0' => 'آد یازدیرمیش ایستیفاده‌چیلر و ایداره‌چیلر',
	'protectsite-move-1' => 'یالنیز ایداره‌چیلر',
	'protectsite-upload-0' => 'آد یازدیرمیش ایستیفاده‌چیلر و ایداره‌چیلر',
	'protectsite-upload-1' => 'یالنیز ایداره‌چیلر',
	'right-protectsite' => 'بعضی قورپلارا ائدیله بیلن ایشلری، بیر محدود زامانا کیمی، محدودلاشدیر',
);
 ...
 */
$messages['ce'] = array(
	'protectsite-createpage' => 'АгӀонаш кхолла магийта',
	'protectsite-createaccount-0' => 'Массо декъашхой',
	'protectsite-createaccount-1' => 'ДӀабазбелла декъашхой а куьйгалхой а',
	'protectsite-createaccount-2' => 'Куьйгалхой бен',
	'protectsite-createpage-0' => 'Массо декъашхой',
	'protectsite-createpage-1' => 'ДӀабазбелла декъашхой а куьйгалхой а',
	'protectsite-createpage-2' => 'Куьйгалхой бен',
	'protectsite-edit-0' => 'Массо декъашхой',
	'protectsite-edit-1' => 'ДӀабазбелла декъашхой а куьйгалхой а',
	'protectsite-edit-2' => 'Куьйгалхой бен',
	'protectsite-move-0' => 'ДӀабазбелла декъашхой а куьйгалхой а',
	'protectsite-move-1' => 'Куьйгалхой бен',
	'protectsite-upload-0' => 'ДӀабазбелла декъашхой а куьйгалхой а',
	'protectsite-upload-1' => 'Куьйгалхой бен',
);
 ...
 */
$messages['id'] = array(
	'protectsite' => 'Lindungi situs',
	'protectsite-desc' => 'Memungkinkan administrator situs untuk memblokir sementara berbagai modifikasi situs',
	'protectsite-text-protect' => '<!--Petunjuk/Komentar/Kebijakan penggunaan-->',
	'protectsite-text-unprotect' => '<!--Petunjuk/Komentar ketika dilindungi-->',
	'protectsite-title' => 'Pengaturan perlindungan situs',
	'protectsite-allowall' => 'Semua pengguna',
	'protectsite-allowusersysop' => 'Pengguna terdaftar dan administrator',
	'protectsite-allowsysop' => 'Administrator saja',
	'protectsite-createaccount' => 'Mengijinkan pembuatan akun baru oleh',
	'protectsite-createpage' => 'Mengijinkan pembuatan halaman oleh',
	'protectsite-edit' => 'Mengijinkan penyuntingan halaman oleh',
	'protectsite-move' => 'Mengijinkan pemindahan halaman oleh',
	'protectsite-upload' => 'Mengijinkan pengunggahan berkas oleh',
	'protectsite-comment' => 'Komentar:',
...
$messages['ja'] = array(
	...
	'protectsite-createpage' => 'ページの作成を許可する利用者グループ',
...
$messages['ka'] = array(
	...
	'protectsite-createaccount' => 'ახალი ანგარიშის შექმნის ნების დართვა',
	'protectsite-createpage' => 'გვერდების შექმნის ნების დართვა',
	'protectsite-edit' => 'გვერდების რედაქტირების ნების დართვა',
	'protectsite-move' => 'გვერდების გადატანის ნების დართვა',
	'protectsite-upload' => 'ფაილების ატვირთვის ნების დართვა',
	'protectsite-timeout' => 'ამოწურვის დრო:',
	'protectsite-timeout-error' => "'''არასწორი ამოწურვის დრო.'''",
	'protectsite-maxtimeout' => 'მაქსიმუმ: $1',
	'protectsite-comment' => 'კომენტარი:',
	'protectsite-ucomment' => 'კომენტარზე დაცვის მოხსნა:',
	'protectsite-until' => 'დაცულია:',
...
$messages['ko'] = array(
	...
	'protectsite-text-protect' => '<!-- 사용할 때 정책/이유/지침 -->',
	'protectsite-text-unprotect' => '<!-- 보호할 때 지침/이유 -->',
	...
	'protectsite-createaccount' => '새 계정 만들기를 허용하는 사용자 그룹',
	'protectsite-createpage' => '문서 만들기를 허용하는 사용자 그룹',
	'protectsite-edit' => '문서 편집을 허용하는 사용자 그룹',
	'protectsite-move' => '문서 이동을 허용하는 사용자 그룹',
	'protectsite-upload' => '파일 올리기를 허용하는 사용자 그룹',
	...
	'right-protectsite' => '제한된 시간 동안 어떤 그룹에 수행 할 수 있는 행동 제한',
);
...
$messages['nl'] = array(
	...
	'protectsite-maxtimeout' => 'Maximum: $1',
	'protectsite-comment' => 'Reactie:',
	'protectsite-ucomment' => 'Opmerkingen bij opheffen beveiliging:',
